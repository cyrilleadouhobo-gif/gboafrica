...
export default function PolePage({ params }) {
  ...
  return (
    <div>
      <section
        style={css(
          'position:relative;overflow:hidden;padding:clamp(44px,9vw,110px) clamp(20px,5vw,64px) clamp(24px,5vw,56px);border-bottom:1px solid var(--border,rgba(255,255,255,.08))'
        )}
      >
