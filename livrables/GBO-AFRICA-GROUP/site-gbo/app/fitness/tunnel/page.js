    ...
    <div style={{ maxWidth: 720, margin: '0 auto', padding: 'clamp(30px,6vw,64px) clamp(20px,5vw,40px) 90px', minHeight: 'calc(100vh - 68px)' }}>
      {tStep === 5 && (
        <div style={{ textAlign: 'center', paddingTop: 20, animation: 'fadeUp .5s both' }}>
          ...
          <h1 style={css("font-family:'Broaven';font-weight:700;font-size:clamp(22px,5vw,34px);letter-spacing:-1px;margin-bottom:14px")}>
      ...
      {tStep === 1 && (
        <div style={{ animation: 'slideIn .35s both' }}>
          <h1 style={css("font-family:'Broaven';font-weight:700;font-size:clamp(20px,4.5vw,30px);letter-spacing:-1px;margin-bottom:8px")}>Qui êtes-vous ?</h1>
      ...
      {tStep === 2 && (
        <div style={{ animation: 'slideIn .35s both' }}>
          <h1 style={css("font-family:'Broaven';font-weight:700;font-size:clamp(20px,4.5vw,30px);letter-spacing:-1px;margin-bottom:8px")}>Quel est votre objectif ?</h1>
      ...
      {tStep === 3 && (
        <div style={{ animation: 'slideIn .35s both' }}>
          <h1 style={css("font-family:'Broaven';font-weight:700;font-size:clamp(20px,4.5vw,30px);letter-spacing:-1px;margin-bottom:8px")}>Renforcez votre accompagnement</h1>
          <p style={css('color:var(--muted,#8a8a8a);font-size:15.5px;margin-bottom:26px')}>
      ...
      {tStep === 4 && (
        <form onSubmit={submitTunnel} style={{ animation: 'slideIn .35s both' }}>
          <h1 style={css("font-family:'Broaven';font-weight:700;font-size:clamp(20px,4.5vw,30px);letter-spacing:-1px;margin-bottom:8px")}>Vos informations</h1>
