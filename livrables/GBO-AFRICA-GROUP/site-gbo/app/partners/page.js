    ...
    <div>
      <section style={css('padding:clamp(80px,10vw,120px) clamp(20px,5vw,64px) clamp(30px,4vw,50px)')}>
        <div style={{ maxWidth: 1000, margin: '0 auto' }}>
          ...
          <h1 style={css("font-family:'Space Grotesk';font-weight:700;font-size:clamp(34px,6vw,60px);letter-spacing:-1.5px;max-width:16ch")}>Grandissons ensemble.</h1>
      ...
      <section style={css('padding:clamp(20px,3vw,40px) clamp(20px,5vw,64px) clamp(64px,9vw,110px)')}>
        ...
        >
          <h2 style={css("font-family:'Space Grotesk';font-weight:700;font-size:24px;margin-bottom:18px")}>Devenir partenaire</h2>
