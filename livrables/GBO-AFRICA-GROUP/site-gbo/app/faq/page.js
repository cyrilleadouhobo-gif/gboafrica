...
export default function FaqPage() {
  return (
    <div style={{ maxWidth: 900, margin: '0 auto', padding: 'clamp(80px,10vw,120px) clamp(20px,5vw,40px) clamp(64px,9vw,110px)' }}>
      ...
      <h1 style={css("font-family:'Big Shoulders Display';font-weight:700;font-size:clamp(34px,6vw,56px);letter-spacing:-1.5px;margin-bottom:40px")}>Questions fréquentes.</h1>
      {FAQ_GROUPS.map((g) => (
